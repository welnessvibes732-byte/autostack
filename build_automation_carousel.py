...
img_exec = r"C:\Users\DELL\.gemini\antigravity\brain\1e1a770e-60c5-45bf-af7c-93e9dd74650b\exec_staring_1779381998603.png"
img_sink = r"C:\Users\DELL\.gemini\antigravity\brain\1e1a770e-60c5-45bf-af7c-93e9dd74650b\dripping_sink_1779205808291.png"
img_pm = r"C:\Users\DELL\.gemini\antigravity\brain\1e1a770e-60c5-45bf-af7c-93e9dd74650b\pm_overwhelmed_1779297487501.png"
img_bleed = r"C:\Users\DELL\.gemini\antigravity\brain\1e1a770e-60c5-45bf-af7c-93e9dd74650b\financial_bleed_1779205856422.png"

exec_b64 = image_to_b64(img_exec)
sink_b64 = image_to_b64(img_sink)
pm_b64 = image_to_b64(img_pm)
bleed_b64 = image_to_b64(img_bleed)
...
# All slides use the cinematic "cover" layout for 100% consistency as requested.
slides = [
    {
        "type": "cinematic",
        "image": exec_b64,
        "kicker": "AETHERA INTELLIGENCE",
        "title": "THE AUTOMATION<br>CEILING.",
        "subtitle": "Why your property managers are drowning in tabs."
    },
    {
        "type": "cinematic",
        "image": sink_b64,
        "kicker": "THE JULY 4TH INCIDENT",
        "title": "ONE BROKEN<br>AC UNIT.",
        "subtitle": "How a $1,200 maintenance ticket<br>cost you a $35,000 renewal."
    },
    {
        "type": "cinematic",
        "image": pm_b64,
        "kicker": "THE SILO TRAP",
        "title": "HUMAN<br>MIDDLEWARE.",
        "subtitle": "Leasing doesn't talk to Maintenance.<br>Maintenance doesn't talk to Accounting."
    },
    {
        "type": "cinematic",
        "image": bleed_b64,
        "kicker": "THE REAL CEILING",
        "title": "SYSTEMIC<br>FAILURE.",
        "subtitle": "You didn't automate operations.<br>You just digitized the bureaucracy."
    },
    {
        "type": "cinematic",
        "image": exec_b64, # Reusing the dark exec image for the pivot
        "kicker": "THE PARADIGM SHIFT",
        "title": "NO MORE<br>SILOS.",
        "subtitle": "Aethera connects the ticket, the vendor quote,<br>and the live P&L in real time."
    },
    {
        "type": "cta",
        "image": exec_b64,
        "text": "Drop 'ARCHITECTURE' in the comments to get our Systemic Scaling Blueprint.",
        "stats": "COMMENT 'ARCHITECTURE' BELOW"
    }
]
...
<title>Aethera Automation Carousel</title>
...
<body>
<button class="dl-btn" onclick="downloadPDF()">⬇ EXPORT AUTOMATION PDF</button>
{slides_html}
<script>
async function downloadPDF() {{
    ...
    pdf.save('Aethera_Automation_Carousel.pdf');
    btn.textContent = '⬇ EXPORT AUTOMATION PDF';
    btn.disabled = false;
}}
</script>
</body>
...
output_path = os.path.join(os.path.dirname(__file__), "automation_ceiling_carousel.html")
with open(output_path, "w", encoding="utf-8") as f:
    f.write(HTML)

print(f"[AUTOMATION] High-End Consistent Carousel saved to: {output_path}")
