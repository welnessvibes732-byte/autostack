  ...
  return (
    <section style={{ position: "relative", height: "100dvh", width: "100%", overflow: "hidden", background: "#000", fontFamily: "'Readex Pro', system-ui, sans-serif" }}>
      ...
      <div className="stat-block" style={{ position: "absolute", right: "96px", top: "14%", textAlign: "right", zIndex: 5 }}>
        ...
        <div style={{ fontSize: "12px", color: "#A1A1AA", marginTop: "4px" }}>to set up</div>
      </div>
      ...
      <div className="stat-block" style={{ position: "absolute", left: "80px", bottom: "110px", zIndex: 5 }}>
        ...
        <div style={{ fontSize: "12px", color: "#A1A1AA", marginTop: "4px" }}>always to start</div>
      </div>
      ...
      <div style={{
        ...
        >
          ...
          <p style={{ color: "#A1A1AA", fontSize: "13px", textAlign: "center", marginBottom: "28px", fontWeight: 300, letterSpacing: "-0.01em" }}>
          ...
          <form onSubmit={handleSignup} style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            <div className="auth-field">
              <label style={{ display: "block", marginBottom: "8px", fontSize: "11px", fontWeight: 400, color: "#A1A1AA", letterSpacing: "0.08em", textTransform: "uppercase" }}>organisation name</label>
            ...
            <div className="auth-field">
              <label style={{ display: "block", marginBottom: "8px", fontSize: "11px", fontWeight: 400, color: "#A1A1AA", letterSpacing: "0.08em", textTransform: "uppercase" }}>email address</label>
            ...
            <div className="auth-field">
              <label style={{ display: "block", marginBottom: "8px", fontSize: "11px", fontWeight: 400, color: "#A1A1AA", letterSpacing: "0.08em", textTransform: "uppercase" }}>password <span style={{ opacity: 0.5 }}>(min 6 chars)</span></label>
          ...
          <p style={{ fontSize: "12px", color: "#A1A1AA", textAlign: "center", marginTop: "20px", letterSpacing: "-0.01em" }}>
            ...
            <Link href="/login" style={{ color: "#A1A1AA", textDecoration: "none" }}
              onMouseEnter={e => (e.currentTarget.style.color = "#fff")}
              onMouseLeave={e => (e.currentTarget.style.color = "rgba(255,255,255,0.65)")}
            >sign in →</Link>
          </p>
