"""
Per-Door Ceiling Carousel Builder
...
slides = [
    {
        "type": "image_hook",
        "image": pm_b64,
        "text": '<div style="font-family: \'Outfit\', sans-serif; font-size: 24px; color: var(--accent); font-weight: 800; letter-spacing: 4px; margin-bottom: 30px;">THE SCALING TRAP: A REAL ESTATE STORY</div><div class="hook-text" style="font-size: 82px; line-height: 1.15;">Why doubling your portfolio just <br><span style="color:var(--red); font-style:italic;">tripled your overhead.</span></div><div style="font-family: \'Outfit\', sans-serif; font-size: 32px; color: var(--muted); margin-top: 40px; font-weight: 300; line-height: 1.4; text-align: center;">The brutal truth about the 75-door breaking point <br>and why hiring more managers won\'t save you.</div>'
    },
    {
        "type": "story",
        "title": "THE MARGIN COLLAPSE",
        "text": 'When you scale from 500 doors to 1,000 doors, your revenue doubles.<br><br><span class="highlight">But your overhead triples.</span>'
    },
    {
        "type": "punch",
        "text": 'To handle the new volume, you hire three more asset managers.'
    },
    {
        "type": "image_story",
        "image": invoices_b64,
        "text": 'Suddenly, you have 6 more salaries eating directly into your Net Operating Income.<br><br>You are forcing highly-paid asset managers to manually bridge the gaps between disconnected software.<br><br>This is the <span class="highlight">Human API Tax.</span>'
    },
    {
        "type": "statement",
        "text": 'The firms pulling ahead in 2026 aren\'t hiring faster.<br><br><span class="blue-box">They are changing their underlying architecture.</span>'
    },
    {
        "type": "story",
        "title": "THE OPERATIONAL ENGINE",
        "text": 'At Aethera, we didn\'t build another dashboard to help your managers "work faster."<br><br>We built an autonomous operational engine that <span class="highlight">multiplies them.</span><br><br>When your architecture automates the connective tissue of your portfolio, the math fundamentally changes.'
    },
    {
        "type": "cta",
        "text": '<div style="font-size:42px; line-height:1.5;">4 people. 500 doors.<br>4 people. 1,000 doors.</div><br><span class="blue-box">Zero compromises.</span><br><br><div style="font-size:36px; color:var(--muted); margin-top:40px;">Stop buying doors if you don\'t have the architecture to run them profitably.</div>',
...
<title>Aethera Per-Door Ceiling Carousel</title>
...
.punch-text {{
    font-family: 'Playfair Display', serif; font-size: 100px; font-weight: 600; font-style: italic;
    color: var(--text); line-height: 1.2; text-align: center; width: 100%;
}}
...
.cta-text {{
    font-family: 'Outfit', sans-serif; font-size: 54px; font-weight: 400; line-height: 1.4; text-align: center; width: 100%; margin-bottom: 60px;
}}
...
async function downloadPDF() {{
    ...
    pdf.save('Aethera_PerDoorCeiling_Carousel.pdf');
...
output_path = os.path.join(os.path.dirname(__file__), "per_door_ceiling_carousel.html")
